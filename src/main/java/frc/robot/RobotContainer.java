...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickAnalogButton(m_driverController, true).whenHeld(m_floorIntake);

    new JoystickButton(m_driverController, Button.kY.value).whenPressed(autoRight).whenReleased(()->autoRight.cancel());
